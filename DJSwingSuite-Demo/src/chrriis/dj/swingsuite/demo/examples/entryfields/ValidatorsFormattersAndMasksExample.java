...
public class ValidatorsFormattersAndMasksExample extends JPanel {
  ...
  public ValidatorsFormattersAndMasksExample() {
    ...
    centerPane.add(createTextEntryFieldWithCustomValidator(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    ...
    centerPane.add(createTextEntryFieldWithForbiddenChars(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    centerPane.add(updateLabel, new GridBagConstraints(2, y++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0));
    // New section: formatters
    ...
    centerPane.add(createDoubleFieldWithDecimalsAndCustomFormatter(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    centerPane.add(updateLabel, new GridBagConstraints(2, y++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0));
    // New section: masks
    ...
    centerPane.add(createTextEntryFieldWithMask(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    centerPane.add(updateLabel, new GridBagConstraints(2, y++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0));
    ...
    centerPane.add(createTextEntryFieldWithMaskAndCustomValidator(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    centerPane.add(updateLabel, new GridBagConstraints(2, y++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0));
    ...
    centerPane.add(createTextEntryFieldWithCustomMask(updateLabel), new GridBagConstraints(1, y, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0));
    centerPane.add(updateLabel, new GridBagConstraints(2, y++, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0));
    // Rest of the initialisation
    add(centerPane, BorderLayout.CENTER);
  }

  private JTextEntryField createTextEntryFieldWithCustomValidator(JLabel updateLabel) {
  ...
  private JTextEntryField createTextEntryFieldWithForbiddenChars(JLabel updateLabel) {
  ...
  private JNumberEntryField<Double> createDoubleFieldWithDecimalsAndCustomFormatter(JLabel updateLabel) {
    ...
    connectUpdateLabel(formattedField, updateLabel);
    return formattedField;
  }

  private JTextEntryField createTextEntryFieldWithMask(JLabel updateLabel) {
    JTextEntryField textEntryField = new JTextEntryField("", 14, "#A-UL-?* '# H");
    connectUpdateLabel(textEntryField, updateLabel);
    return textEntryField;
  }

  private JTextEntryField createTextEntryFieldWithMaskAndCustomValidator(JLabel updateLabel) {
    ...
    connectUpdateLabel(maskField, updateLabel);
    return maskField;
  }

  private JTextEntryField createTextEntryFieldWithCustomMask(JLabel updateLabel) {
